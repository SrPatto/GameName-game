...
func first_item():
	...
	if next_item_lvl < 3:
		match next_item_lvl:
			2: new_item.item = preload("uid://dsfw7wy4kybh5")
			3: new_item.item = preload("uid://bofa8klvyd7pj")
	else:
...
func second_item():
	...
	if next_item_lvl < 3:
		match next_item_lvl:
			1: new_item.item = preload("uid://c3f03w8x21knw")
			2: new_item.item = preload("uid://cj76mebs0rq0w")
			3: new_item.item = preload("uid://d4jp50ixs8r1h")
	else:
...
func third_item():
	...
	if next_item_lvl < 3:
		match next_item_lvl:
			1: new_item.item = preload("uid://djbdv7m0nko8l")
			2: new_item.item = preload("uid://c4l2mxosx3blf")
			3: new_item.item = preload("uid://5625sa3o35xk")
	else:
